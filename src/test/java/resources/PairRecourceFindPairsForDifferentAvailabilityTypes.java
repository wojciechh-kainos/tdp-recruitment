...
public class PairRecourceFindPairsForDifferentAvailabilityTypes {
    ...
    public void setUp(){
        ...
        AvailabilityTypes typeAvailable = MockDataUtil.createAvailableType((long) 1, "available");
        AvailabilityTypes typeMaybe = MockDataUtil.createAvailableType((long) 5, "maybe");
